...
import { incomeFormSchema, getIncomeFormDefaults } from '@/schemas/income-form';
import type { IncomeFormValues } from '@/schemas/income-form';
...
export function IncomeForm({ income, categories }: IncomeFormProps) {
  ...
  const methods = useForm<IncomeFormValues>({
    ...
    defaultValues: getIncomeFormDefaults(income),
  });
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <FormField name="description" label="รายละเอียด" required className="sm:col-span-2">
                <Input id="description" {...register('description')} placeholder="เช่น ค่าซ่อมแอร์ลูกค้า" />
              </FormField>
