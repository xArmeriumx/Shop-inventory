...
const featureGuides = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        subtitle: 'ยกเลิกรายการขาย',
        items: [
          'กดปุ่ม ❌ "ยกเลิกรายการ"',
          'เลือกเหตุผล: ผิดพลาด/ลูกค้าขอ/ชำรุด/อื่นๆ',
          'Stock จะถูกเพิ่มกลับอัตโนมัติ',
          'รายการแสดงสถานะ "ยกเลิกแล้ว"',
          'ข้อมูลยังอยู่ - ตรวจสอบได้ทุกเมื่อ',
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'ปรับ Stock ด้วยตนเอง: ใช้ปุ่ม "ปรับสต็อก"',
          'ดูประวัติ Stock: แท็บ "ประวัติสต็อก"',
          'ดูสินค้าใกล้หมดได้ที่ Dashboard',
        ],
      },
      {
        subtitle: 'ระบบยกเลิกรายการ (แทนการลบ)',
        items: [
          'ข้อมูลไม่ถูกลบจริง - รักษา Audit Trail',
          'บังคับกรอกเหตุผล: ผิดพลาด/ลูกค้าขอ/ชำรุด',
          '↩ Stock ถูกปรับอัตโนมัติ (คืน/หัก)',
          'ป้องกันสต็อกติดลบ',
          'บันทึกว่าใครยกเลิก เมื่อไหร่',
